-- Fix trigger function to use correct pg_net function
...
BEGIN
  ...
  -- Call Edge Function asynchronously using pg_net (FIXED: use net.http_post instead of extensions.http_post)
