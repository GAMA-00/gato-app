-- Replace RPC to avoid BEFORE INSERT duplicate-trigger by updating first
...
BEGIN
  ...
  -- Reserve existing provider_time_slot FIRST to avoid BEFORE INSERT duplicate errors
