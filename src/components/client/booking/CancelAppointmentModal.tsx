...
export const CancelAppointmentModal = ({
  ...
  const handleCancelRecurring = async () => {
    ...
    try {
      ...
      // Cancel the base appointment by setting recurrence to 'none'
      ...
      // Find and cancel all future appointments with the same pattern
      ...
      console.error('Error canceling recurring appointment:', error);
      toast.error(`Error al cancelar serie: ${error.message}`);
    } finally {
      setIsLoading(false);
    }
  };
