...
const ServiceInfo = ({ isPostPayment }: ServiceInfoProps) => {
  return (
    <Alert className="border-l-4 border-l-blue-500 bg-blue-50/50 border-blue-200 p-3 md:p-4">
      <Info className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />
      <AlertDescription>
        <div className="space-y-2 md:space-y-3">
          <h4 className="font-semibold text-blue-900 mb-1 md:mb-2 text-sm md:text-base">Información importante del servicio</h4>
          
          <div className="space-y-1.5 md:space-y-2 text-xs md:text-sm">
            {/* Solo para servicios postpago */}
            {isPostPayment && (
              <div className="flex items-start gap-1.5 md:gap-2">
                <div className="w-1 h-1 md:w-1.5 md:h-1.5 rounded-full bg-blue-600 mt-1.5 md:mt-2 flex-shrink-0"></div>
                <div>
            ...
            <div className="ml-3 md:ml-4 space-y-0.5 md:space-y-1 text-blue-800">
              ...
              <div className="flex items-center gap-1.5 md:gap-2">
                <Clock className="h-3 w-3 md:h-4 md:w-4 text-red-500 flex-shrink-0" />
