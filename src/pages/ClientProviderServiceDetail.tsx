      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="md:ml-52">
          <PageContainer title="Cargando..." subtitle="">
            <div className="space-y-6 w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 2xl:max-w-4xl 2xl:px-12">
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="md:ml-52">
          <PageContainer title="Error" subtitle="">
            <div className="text-center py-12 w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 2xl:max-w-4xl 2xl:px-12">
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="md:ml-52">
        <PageContainer title="" subtitle="">
          <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 2xl:max-w-4xl 2xl:px-12">
