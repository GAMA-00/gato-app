    ...
    >
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-6 px-2 md:px-4 max-w-4xl mx-auto animate-fade-in">
        {services.map((service) => (
          <Card 
            key={service.id}
            className={`flex flex-col items-center p-3 md:p-6 hover:shadow-lg transition-all cursor-pointer bg-[#3A2F2D] text-white justify-center group ${isMobile ? 'h-28' : 'h-36'}`}
